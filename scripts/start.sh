...
configure_env_variables() {
  ...
  local quoted_vars=(
    ...
    DEFAULT_REGION BUCKET BUCKET_PATH HOST_BASE HOST_BUCKET SSL_SECURE
    ...
    CHECKSUM_VALIDATION CONSOLE_LOGGING MONITORING_ENDPOINT_COMMAND HEALTHCHECKS_URL ENTRYPOINT_START JSON_LOGGING
  )
